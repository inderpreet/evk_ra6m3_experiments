...
/* Actual period: 0.001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xea60,
  .duty_cycle_counts = 0x7530, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = tmr0_callback,
...
sci_uart_instance_ctrl_t uart_one_ctrl;

baud_setting_t uart_one_baud_setting =
        {
...
const sci_uart_extended_cfg_t uart_one_cfg_extend =
{ .clock = SCI_UART_CLOCK_INT, .rx_edge_start = SCI_UART_START_BIT_FALLING_EDGE, .noise_cancel =
          SCI_UART_NOISE_CANCELLATION_DISABLE,
  .rx_fifo_trigger = SCI_UART_RX_FIFO_TRIGGER_MAX, .p_baud_setting = &uart_one_baud_setting, .flow_control =
...
/* Instance structure to use this module. */
const uart_instance_t uart_one =
{ .p_ctrl = &uart_one_ctrl, .p_cfg = &uart_one_cfg, .p_api = &g_uart_on_sci };
